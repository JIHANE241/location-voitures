...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if (isset($_POST["login"])) {
      ...
      $sql = "SELECT * FROM users WHERE (email='$identifiant' OR username='$identifiant') AND password='$password'";
      ...
      <div class="overlay-container">
        <div class="overlay">
          <div class="overlay-panel overlay-left">
            ...
            <img src="car.avif" style="height: 25rem; width: 30rem; padding-top: 5%;" />
            <button class="btn" id="signInBtn">Sign In</button>
          </div>
          <div class="overlay-panel overlay-right">
            <h1>Come on, book your dream car now!</h1>
            <img src="car.avif" style="height: 25rem; width: 30rem;" />
